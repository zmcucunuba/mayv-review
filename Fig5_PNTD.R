...
fois$subtitle[fois$subtitle == "Trinidad and Tobago 1958"] <- "Trinidad &Tobago\n(1958)"
...
pp <- 
  plot_grid (pp1, pp2, rel_heights = c(1.1, 1), nrow = 2, labels = 'AUTO', label_size = 30)



tiff(file = "figs/Fig5.FOI.tiff", 
    bg = "transparent",
    width = 1500 * 1.5, height = 700 * 1.5)
pp
dev.off()
